...
export default function Home() {
  ...
  return (
    <div
      className={clsx(
        "grid gap-2 h-lvh p-4 transition-all duration-3000",
        view ? "grid-cols-[1fr_2fr_1fr]" : "grid-cols-[1fr]"
      )}
    >
      {view && <Projects projects={projectsGridOne} />}
      ...
      {view && <Projects projects={projectsGridTwo} />}
    </div>
  );
}
